...
{
public:
    explicit ObjectPool(std::size_t initial_size = 1000, std::size_t grow_size = 1024) : _grow_size(grow_size)
    {
     ...
     */
    template <typename... Args> std::shared_ptr<T> Acquire(Args &&...args)
    {
